...
var PeriodicTable = ({ onElementClick }) => {
  ...
  const elementsJSX = elements.map((el) => /* @__PURE__ */ jsxDEV2("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxDEV2("div", {
        style: { fontSize: "0.9em", color: "#333", overflowWrap: "anywhere" },
        children: el.name
      }, undefined, false, undefined, this)
    ]
  }, el.atomic_number, true, undefined, this));
  return /* @__PURE__ */ jsxDEV2("div", {
...
var PeriodicTable_default = PeriodicTable;
...
var ElementInfo = ({ elementId }) => {
  ...
  return /* @__PURE__ */ jsxDEV2("div", {
    style: { display: "flex", flexDirection: "column", alignItems: "center", margin: "20px" },
    children: element ? /* @__PURE__ */ jsxDEV2("div", {
      style: { width: "500", border: "1px solid #ccc", padding: "10px", borderRadius: "5px", height: "400" },
      children: [
        /* @__PURE__ */ jsxDEV2("h3", {
          children: [
...
var App = () => {
  ...
  return /* @__PURE__ */ jsxDEV2("div", {
    children: [
      ...
      /* @__PURE__ */ jsxDEV2(PeriodicTable_default, {
